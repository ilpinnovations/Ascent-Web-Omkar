...
$sql1 = "UPDATE schedule SET sched_date='$date1',sched_time='$time1',sched_activity='$activity1',sched_faculty='$faculty1' WHERE sched_id='$id1'";
$result = mysql_query($sql1, $ascent);
if($result){
$result = mysql_query("SELECT * FROM schedule WHERE sched_date='$date1'", $ascent);
...
$result6 = mysql_query("SELECT * FROM schedule WHERE sched_date='$date1'", $ascent);
